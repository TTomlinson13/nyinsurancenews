    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-200 mb-8">Your trusted source for New York insurance news, laws, and resources</p>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900 to-blue-700 text-white">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Find Better New York Insurance?</h2>
          ...
          <a href="https://app.usecanopy.com/c/tomlinson-and-co" target="_blank" rel="noopener noreferrer"
            ...
            🚀 Get Your Free New York Insurance Quote
          </a>
          <p className="mt-4 text-blue-200 text-sm">No obligation · Takes 2 minutes · Local New York agents available</p>
        </div>
      </section>
